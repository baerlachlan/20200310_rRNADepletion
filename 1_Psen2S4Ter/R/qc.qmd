...
#| results: hide
fqc_raw <- list.files(
    path = "1_Psen2S4Ter/smk-rnaseq-counts-1.2.2/results/raw_data/FastQC",
    pattern = "zip",
    full.names = TRUE
)
...
```{r fqc_trim}
fqc_trim <- list.files(
    path = here("1_Psen2S4Ter/smk-rnaseq-counts-1.2.2/results/trim/FastQC"),
    pattern = "zip",
    full.names = TRUE
) %>%
    FastqcDataList()  %>%
...
fqc_align <- list.files(
    path = here("1_Psen2S4Ter/smk-rnaseq-counts-1.2.2/results/align/FastQC"),
    pattern = "zip",
    full.names = TRUE
) %>%
    FastqcDataList() %>%
...
star_logs <- list.files(
    "1_Psen2S4Ter/smk-rnaseq-counts-1.2.2/results/align/log",
...
fc_str <- load_fc_summary(here(
    "1_Psen2S4Ter/smk-rnaseq-counts-1.2.2/results/featureCounts",
...
<!--     "1_Psen2S4Ter/smk-rnaseq-counts-1.2.2/results/sal", -->
