...
#SBATCH --mem=32GB
#SBATCH -o /hpcfs/users/a1647910/20200310_rRNADepletion/3_K97Gfs/slurm/%x_%j.out
#SBATCH -e /hpcfs/users/a1647910/20200310_rRNADepletion/3_K97Gfs/slurm/%x_%j.err
...
## Directories
PROJROOT=/hpcfs/users/a1647910/20200310_rRNADepletion/3_K97Gfs
