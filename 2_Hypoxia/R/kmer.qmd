...
```{r}
files <- list.files(
    # path = "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/old_bash_analysis/0_rawData/FastQC",
...
```{r k5counts}
k5files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k5",
...
```{r k6counts}
k6files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k6",
    pattern = ".dumps", full.names = TRUE
)
...
```{r k7counts}
k7files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k7",
    pattern = ".dumps", full.names = TRUE
)
...
```{r k8counts}
k8files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k8",
    pattern = ".dumps", full.names = TRUE
)
...
```{r k9counts}
k9files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k9",
    pattern = ".dumps", full.names = TRUE
)
...
```{r k10counts}
k10files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k10",
    pattern = ".dumps", full.names = TRUE
)
...
```{r k11counts}
k11files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k11",
    pattern = ".dumps", full.names = TRUE
)
...
```{r k12counts}
k12files <- list.files(
    "/mnt/phoenix/gpfs/20200310_rRNADepletion/2_Hypoxia/analysis-kmer/results/jellyfish/k12",
    pattern = ".dumps", full.names = TRUE
)
