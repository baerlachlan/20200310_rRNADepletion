...
```{r files}
files <- list.files(
  path = "/hpcfs/users/a1647910/20200310_rRNADepletion/2_Hypoxia/0_rawData/FastQC",
  pattern = "zip",
  full.names = TRUE
)
```
...
```{r trimFqc}
trimFqc <- list.files(
  path = "/hpcfs/users/a1647910/20200310_rRNADepletion/2_Hypoxia/1_trimmedData/FastQC",
  pattern = "zip",
  full.names = TRUE
) %>%
  FastqcDataList()
...
bwaMapped <- read.delim(
  "/hpcfs/users/a1647910/20200310_rRNADepletion/2_Hypoxia/3_bwa/log/samples.mapped.all", 
  sep = ":", 
