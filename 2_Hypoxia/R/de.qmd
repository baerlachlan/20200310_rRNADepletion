...
list.files(here("2_Hypoxia/analysis-kmer/results/bwa/rrna_props/")) %>%
    .[str_remove(basename(.), ".rrna") %in% samples$sample]
rRnaProp <- read.delim(
    "/mnt/phoenix/hpcfs/20200310_rRNADepletion/2_Hypoxia/old_bash_analysis/3_bwa/log/samples.mapped.all",
    sep = ":", 
    col.names = c("sample", "proportion"), 
...
saveRDS(tt_deconv, here("2_Hypoxia/Rdata/tt_deconv.Rds"))
```
